...
// NOTE: Full i18n expansion + remaining polish is in branch work; this commit restores a working page
// with critical fixes: skeleton tips (no fake fixtures), --fg CSS fix, lang hash preserve, sticky CTA.
...
<section class="hero" id="home">
  <div class="wrap heroGrid">
    <div>
      ...
      <div class="pills" style="display:flex;gap:7px;flex-wrap:wrap;margin-top:18px"><span class="pill" style="padding:6px 10px;border:1px solid var(--border);border-radius:999px;color:var(--muted);font-size:.66rem;font-weight:700">18+</span><span class="pill" style="padding:6px 10px;border:1px solid var(--border);border-radius:999px;color:var(--muted);font-size:.66rem;font-weight:700">Promo ${promo}</span></div>
    </div>
    <div id="edge-visual"><div class="phone" style="max-width:340px;margin:0 auto;padding:2px;border:1px solid #dbeafeaa;border-radius:28px;background:#0b121d"><div style="padding:16px;color:var(--muted);font-size:.75rem">Telegram-first cash desk · Open the bot for guided deposit &amp; tips.</div></div></div>
  </div>
</section>
