...
export const translations = {
  si: {
    ...
    cancelled: "❌ සියලුම ක්‍රියාකාරකම් අවලංගු කරන ලදී.\n\nපහත මෙනුවෙන් සේවාවක් තෝරන්න:",
    mainMenuHeader: "📋 ප්‍රධාන මෙනුව:",
    btnDeposit: "💰 තැන්පතු",
    btnConfirmDeposit: "📸 තැන්පතු තහවුරු කරන්න",
    btnWithdraw: "💸 මුදල් ආපසු ගැනීම",
    btnHistory: "📜 ගනුදෙනු ඉතිහාසය",
    btnRegistration: "🎯 1XBet ලියාපදිංචිය",
    btnReferral: "🔄 යොමු පුවරුව",
    btnLanguage: "🌐 භාෂාව",
    btnHelp: "❓ සහාය",
    btnDashboard: "📊 පුවරුව",
    btnFreeTips: "🎯 නොමිලේ උපදෙස්",
    btnSupportTicket: "🎫 සහාය ටිකට්පත",
    btnResponsibleGaming: "🛡️ වගකීම් සහිත ක්‍රීඩාව",
    btnMyId: "🆔 මගේ හැඳුනුම",
    btnShareBot: "📣 බොට් බෙදාගන්න",
    btnOfficialChannel: "📢 නිල චැනල්",
    btnAdminPanel: "🧑‍💼 පරිපාලක පුවරුව",
    btnBack: "⬅️ ආපසු",
    forceJoinMsg: "බොට් භාවිතා කිරීමට පෙර කරුණාකර අපගේ නිල චැනල් එකට එක්වන්න.",
    joinChannelBtn: "📢 චැනල් එකට එක්වන්න",
    checkJoinBtn: "✅ මම එක්වුණා",
  ...
  en: {
    ...
    btnFreeTips: "🎯 Free Tips",
    btnSupportTicket: "🎫 Support Ticket",
    btnResponsibleGaming: "🛡️ Responsible Gaming",
    btnMyId: "🆔 My ID",
    btnShareBot: "📣 Share Bot",
    btnOfficialChannel: "📢 Official Channel",
  ...
  ta: {
    ...
    cancelBtn: "❌ ரத்துசெய்",
    cancelled: "❌ உங்கள் செயல்பாடு ரத்துசெய்யப்பட்டது.\n\nகீழேயுள்ள மெனுவிலிருந்து தேர்வுசெய்யவும்:",
    mainMenuHeader: "📋 முதன்மை மெனு:",
    btnDeposit: "💰 பணம் வைப்பு",
    btnConfirmDeposit: "📸 வைப்பை உறுதிப்படுத்து",
    btnWithdraw: "💸 பணம் எடுத்தல்",
    btnHistory: "📜 பரிவர்த்தனை வரலாறு",
    btnRegistration: "🎯 1XBet பதிவு",
    btnReferral: "🔄 பரிந்துரை பலகை",
    btnLanguage: "🌐 மொழி",
    btnHelp: "❓ உதவி",
    btnDashboard: "📊 முகப்புப் பலகை",
    btnFreeTips: "🎯 இலவச குறிப்புகள்",
    btnSupportTicket: "🎫 உதவிச் சீட்டு",
    btnResponsibleGaming: "🛡️ பொறுப்பான விளையாட்டு",
    btnMyId: "🆔 என் அடையாளம்",
    btnShareBot: "📣 போட்டைப் பகிரவும்",
    btnOfficialChannel: "📢 அதிகாரப்பூர்வ சேனல்",
    btnAdminPanel: "🧑‍💼 நிர்வாகப் பலகை",
    btnBack: "⬅️ பின்செல்க",
    forceJoinMsg: "போட்டைப் பயன்படுத்துவதற்கு முன் எங்கள் அதிகாரப்பூர்வ சேனலில் இணையவும்.",
    joinChannelBtn: "📢 சேனலில் இணையவும்",
    checkJoinBtn: "✅ நான் இணைந்துவிட்டேன்",
