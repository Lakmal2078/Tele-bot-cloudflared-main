...
const env: Env = {
  ...
  TIPS_MIN_CONSENSUS: process.env.TIPS_MIN_CONSENSUS || "",
  TIPS_MIN_VALUE: process.env.TIPS_MIN_VALUE || "",
  TIPS_MIN_BOOKMAKERS: process.env.TIPS_MIN_BOOKMAKERS || "",
  TIPS_MAX_STALE_HOURS: process.env.TIPS_MAX_STALE_HOURS || "",
